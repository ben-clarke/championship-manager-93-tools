...
const PersonOff = ({ className, testId = "person-off" }: IconProps): JSX.Element => (
  <svg
    viewBox="0 0 48 48"
    className={className}
    fill="none"
